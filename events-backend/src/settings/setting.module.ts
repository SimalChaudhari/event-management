...
import {  BannerService, BannerEventService, LogoService, PrivacyPolicyService, TermsConditionsService, UserPermissionsService, PermissionTemplateService, PushNotificationService, AdvertNotificationService } from './setting.service';
