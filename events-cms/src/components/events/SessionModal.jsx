...
const SessionModal = ({
    ...
    const title = isViewMode ? 'Session Details' : currentSession ? 'Edit Session' : 'Add Session';
    ...
    return (
        <FormRightSidebar show={show} onHide={onHide} title={title} footer={footer} width={600}>
            {isViewMode ? (
                currentSession && (
                    <Row>
                        ...
                        <Col md={4} className="mb-2">
                            <div className="form-group mb-0">
                                ...
                                <div style={{ padding: '4px 0 0 0', minHeight: '24px' }}>
                                    {currentSession.startTime && formatTime
                        ...
                        <Col md={4} className="mb-2">
                            <div className="form-group mb-0">
                                ...
                                <div style={{ padding: '4px 0 0 0', minHeight: '24px' }}>
                                    {currentSession.endTime && formatTime
                                ...
                                <>
                                    <Select
                                        ...
                                        options={speakerList.map((speaker) => ({
                                            value: speaker.id,
                                            label:
                                                `${speaker.firstName || ''} ${speaker.lastName || ''}${speaker.email ? ` - ${speaker.email}` : ''}`.trim() ||
                                                speaker.email ||
                                                `Speaker ${speaker.id}`
                                        }))}
