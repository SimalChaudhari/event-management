      ...
      <form onSubmit={handleSubmit}>
        ...
        <Modal.Body>
          <Row>
            ...
            <Col sm={6}>
              <div className="form-group fill">
                <label className="floating-label" htmlFor="mobile">Mobile</label>
                <input
                  type="text"
                  className="form-control"
                  name="mobile"
            ...
            <Col sm={4}>
              <div className="form-group fill">
                <label className="floating-label" htmlFor="postalCode">Postal Code</label>
                <input
                  type="text"
                  className="form-control"
                  name="postalCode"
            ...
            <Col sm={6}>
              <div className="form-group fill">
                <label className="floating-label" htmlFor="profilePicture">Profile Picture</label>
                <input
                  type="file"
                  className="form-control"
                  name="profilePicture"
              ...
              <div className="form-group">
                <div className="custom-control custom-switch">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="custom-control-label" htmlFor="isMember">Is Member</label>
                </div>
              </div>
            </Col>
            <Col sm={6}>
              <div className="form-group">
                <div className="custom-control custom-switch">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="custom-control-label" htmlFor="biometricEnabled">Biometric Enabled</label>
                </div>
              </div>
            </Col>
          </Row>
